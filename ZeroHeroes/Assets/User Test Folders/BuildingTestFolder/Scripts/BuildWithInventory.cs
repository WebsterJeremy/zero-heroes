...
public class BuildWithInventory : MonoBehaviour
{
    ...
    public void PlaceTile(TileBase tTile, int layerNum, bool col)
    {
        Vector3 point = Camera.main.ScreenToWorldPoint(Input.mousePosition);
        point.z = Camera.main.nearClipPlane;
        ...
        {
            case 0:
                tilemp = GameObject.FindGameObjectWithTag("Backround").GetComponent<Tilemap>();
                break;
        ...
        tilemp.SetTile(selectedTile, tTile);
